...
WebUI.setText(findTestObject('Object Repository/1st Month/day 23/23rd day test6/Page_Scale Basic Pays/input__MinSalary'), 
    '500')

WebUI.setText(findTestObject('Object Repository/1st Month/day 23/23rd day test6/Page_Scale Basic Pays/input__Increment'), 
    '500')

WebUI.setText(findTestObject('Object Repository/1st Month/day 23/23rd day test6/Page_Scale Basic Pays/input__NumberOfStages'), 
    '5')
